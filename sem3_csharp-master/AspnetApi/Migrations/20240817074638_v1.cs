    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeOptionProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttributeOptionProducts_AttributeOptions_AttributeOptionId",
                        column: x => x.AttributeOptionId,
                        principalTable: "AttributeOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttributeOptionProducts_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeOptionProducts_AttributeOptionId",
                table: "AttributeOptionProducts",
                column: "AttributeOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_AttributeOptionProducts_ProductId",
                table: "AttributeOptionProducts",
                column: "ProductId");
